...
def home() -> str:
    ...
    header = project_header("WORK & PRODUCTIVITY", "AI drafts clips. SourceCut blocks unsupported claims.", "Every publishable hook and caption stays tied to the exact source quote and timestamp that supports it.", "3 steps", "source · review · render")
